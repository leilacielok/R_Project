...
```
#with colour=blue I can see that many european countries are on the same level as most asian ones. What is that determines the differences among countries in the same continent?
```{r}
