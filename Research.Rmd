...
linear.plot
```
# Before, we found out that the effect of the Gross National Income was overcome when adding the Human Development Index, which is highly statisticlaly significant, and the population, whcih is significant at the 1% level.
...
scatter3D <- scatterplot3d(cbind(x=IQdataset$HDI..2021., z=IQdataset$GNI...2021, y=IQdataset$Average.IQ), xlab="HDI",
                           ...
                           color="blue", angle=45, pch=20, main = "IQ over Quality of life", axis = TRUE, tick.marks = TRUE,
                           highlight.3d = TRUE)
```
